...
?>
 <div id="page-wrapper">
   <div class="row">
     <div class="col-lg-10"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Trayectorias Escolares</b></font></h2></div>
	...
	<div class="row">
     <div class="col-lg-10">
      <div class="panel panel-primary">
        <div class="panel-heading"> Seleccione el estudiante que desea consultar</div><br>
...
?>
			    ...
			    </div><hr><!--fin row seleccion de curso-->
<?php  
...
?>
			 ...
			 </div><hr><!-- fin row seleccion estudiante-->
<?php  
...
?>
                      <div class="row">
					   <div class="col-lg-12"><div class="alert alert-dismissible alert-danger"><strong><center>Por favor seleccione un estudiante.</center></strong></div></div>
