	  ...
	  <div class="panel panel-info">
		<div class="panel-heading bg-info">
          <div class="row">
				...
				<div class="col-lg-5">"<?php echo $CursoElegido['ANIO']." - ".$CursoElegido['DIVISION']." Division        -              "; ?><?php echo ($CursoElegido['ANIO']=='1ro'||$CursoElegido['ANIO']=='2do'||$CursoElegido['ANIO']=='3ro') ? 'Ciclo Basico' : 'Ciclo Orientado'; ?>"</div>
            </div><!--fin row heading-->
