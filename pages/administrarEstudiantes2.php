          ...
          <div class="col-lg-4"></div>
			<div class="col-lg-3">
               <form role="form" method="post">
                  <button class="btn btn-primary" type="submit" name="EstudianteNuevo" formaction="EstudianteNuevo.php"><box-icon  name="plus" type="solid" size="md" color="white" animation="tada-hover"></box-icon> Nuevo</button></div>
             <div class="col-lg-3">
                  <button class="btn btn-primary" type="submit" name="BuscarEstudiante" formaction="buscarUnEstudiante.php"><box-icon  name="search" size="md" color="white" animation="tada"></box-icon> Buscar</button></div>
             </div>  <!-- /.row botone -->
