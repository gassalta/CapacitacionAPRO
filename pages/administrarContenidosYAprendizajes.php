...
?>
	<div class="row" align="center">
      <div class="col-lg-10"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Contenidos y Aprendizajes de <?php echo $NEC?></b></font></h2>  </div></div>
    </div> <!-- /.row titulo --><br>
    <div class="row">
      <div class="col-lg-10">
						  ...
						  if($ListadoContenidos[$i]['ESTADO']=='0')
							{
							  ?>
                              <tr> 
							  <th><font color="#005eff"><?php echo $ListadoContenidos[$i]['ID']; ?></font></th>
<?php 		
						    ...
						    <button class="btn btn-danger btn-circle" type="submit"  name="eliminar"  onclick="return confirm ('¿Seguro que desea eliminarlo?')"><box-icon  name="trash"  size="md" color="white" animation="tada-hover"></box-icon></button></form></td></tr>
...
?>
						<tr><td colspan="6"><b><a href="contenidoNuevo.php?Cx=<?php echo $NEC; ?>"><box-icon  name="plus-circle" type="solid" size="md"  color="#005eff" animation="tada-hover"></box-icon> Registrar un nuevo contenido</b></a></td></tr>
                </tbody>
              </table> 
           </div>
		  </div>
...
<?php
 ...
 ?>
		...
		<div class="row" align="center">
			...
			<div class="col-lg-6">											
				<button class="btn btn-primary" type="submit" name="Aprendizajes" formaction="funciones/emitirPDFListadoAprendizajesXEspCurr.php" onClick="return confirm ('Seguro que desea emitir el informe?');"><box-icon name="download" type="solid" size="sm" color="white" animation="fade-down"></box-icon> Emitir listado de Aprendizajes por Espacio Curricular</button></div>
		   <div class="col-lg-2">
				<button class="btn btn-danger" type="submit" name="Cancelar" formaction="index.php"><box-icon  name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar </button> </div>
		</div><!-- /.row botones-->
   </div>    <!-- /.col principal -->
  </div><!-- /.row principal-->
 </div> <!-- /#page-wrapper -->
