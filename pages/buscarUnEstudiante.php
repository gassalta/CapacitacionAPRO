  ...
  <div id="page-wrapper">
   <div class="row">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading"><center>Estudiante N° <?php echo $IdEstudiante ?></center></div>
...
?>
		...
		<div class="col-lg-3"><label>Fecha de Nacimiento </label><input id="date" type="date" name="fechaNacim" value="<?php echo !empty($_POST['fechaNacim']) ? $_POST['fechaNacim'] : ''; ?>" readonly></div>
		</div>
		</div><!-- segunda linea--><br>
		<div class="row">
		  <div class="form-group">
...
?>
		...
		<div class="row">
          <div class="form-group">
			<div class="col-lg-4"><label>Padre</label>
...
?>
			...
			<div class="col-lg-4"><label>Madre</label>
...
?>
			...
			<div class="col-lg-4"><label>Tutor/a</label>
...
?>
		...
		</div></div><!--quinta linea-->	<br> 
		<div class="row">
         <div class="form-group">
		  <div class="col-lg-4"><label>N° Legajo</label>
            <input class="form-control" name="nroLegajo" value="<?php echo !empty($_POST['nroLegajo']) ? $_POST['nroLegajo'] : ''; ?>" readonly></div>
		  <div class="col-lg-4"><label>N°Libro Matriz</label><input class="form-control" name="nroLibroMatriz" value="<?php echo !empty($_POST['nroLibroMatriz']) ? $_POST['nroLibroMatriz'] : ''; ?>" readonly></div>
		  <div class="col-lg-4"><label>N° Folio</label><input class="form-control" name="nroFolio" value="<?php echo !empty($_POST['nroFolio']) ? $_POST['nroFolio'] : ''; ?>" readonly></div>
		</div></div><!--sexta linea -->	<br> <br>
		<div class="row">
		<div class="form-group">
           <div class="col-lg-4"><label>Curso al que pertenece</label></div>
