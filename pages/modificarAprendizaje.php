...
?>
	<div id="page-wrapper">
	 <div class="row">
        <div class="col-lg-10"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center> <?php if($Tipo=='E'){echo 'Eliminar Aprendizaje';} elseif($Tipo=='M') {echo'Modificar Aprendizaje';}else{echo'Nuevo Aprendizaje';}?></h3></center></font></div></div>
		</div><br>
     <div class="row">
        <div class="col-lg-10">
		    <div class="panel panel-primary">
					<div class="panel-heading"><center>Por favor complete los datos<center></div><br><br>
...
?>
				...
				<div class="form-group">
					<label>Nombre del Aprendizaje</label><input  class="form-control bg-primary" name="NombreAprendizaje" value="<?php if($Tipo!='A'){ echo $DenominacionAprendizaje;} ?>" <?php if($Tipo=='A')echo'required';?><?php if($Tipo=='E')echo'readonly';?>> 
                </div></div>
				</div><br><br>
			...
			<input type="Hidden"name="IdContenido" value=<?php echo"$Cont"?>>				
			 <div class="row" align="center">
				...
				<div class="col-lg-4"><button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('¿Desea guardar los cambios del Aprendizaje?');"><box-icon name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon><?php if($Tipo=='E')echo'Eliminar'; elseif($Tipo=='M') echo' Modificar'; else echo' Confirmar' ?></button> </div>
			   </form>
				<div class="col-lg-4"><Form Action="Aprendizajes.php?Cx=<?php echo $Cont; ?>&Cn=<?php echo $Contenido; ?>&Ec=<?php echo $EspacioCurricular; ?>" Method="Post"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar" ><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar</button></div>
		    </div><br>
    </div>
    </div>
    </div>
