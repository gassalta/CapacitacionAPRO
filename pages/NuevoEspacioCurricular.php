      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="col-lg-12">
            <h2 class="tile-title">
              <font color="#85C1E9">
                <center><b>Nuevo Espacio Curricular</b>
              </font>
            </h2>
          </div>
        </div>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <center>Complete los datos</center>
            </div>
            <div class="panel-body">
                    ...
                    ?>
                          <div class="bs-component">
                            <div class="alert alert-dismissible alert-success"><strong>
                                <center>¡Nuevo Espacio Curricular guardado!</center>
                              </strong></div>
                          </div>
                        <?php
                        }
              ...
              <div class="row" align="center">
                ...
                <div class="col-lg-1" align="center"><abbr title="Aquí usted puede añadir un área que no se encuentre en el listado"><button type="submit" class="btn btn-primary btn-circle" value="NacionalidadNueva" name="NacionalidadNueva" formaction="NuevoArea.php">
                      <box-icon name="plus-circle" type="solid" size="sm" color="white" animation="tada-hover"></box-icon>
                    </button></abbr> </div>
              ...
              <div class="row" align="center">
                <div class="col-lg-12">
                  <div class="alert alert-dismissible alert-info">
                    <center><b>Los campos marcados con * son obligatorios</b>
                  </div>
                </div>
              </div><!-- /.row aviso --><br>
              <div class="row" align="center">
                <div class="col-lg-3"></div>
                <div class="col-lg-3"> <button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('¿Seguro desea guardar el nuevo Espacio Curricular?');">
                    <box-icon name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon> Confirmar
                  </button></div>
                <div class="col-lg-3"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar">
