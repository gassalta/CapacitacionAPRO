...
?>
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-10"><h1 class="page-header"><font color="#85C1E9"><center>Búsqueda de Estudiantes</center></font></h1></div>
    </div><!-- /.row titulo -->
	<div class="row">
    <div class="col-lg-10">
			...
			if(!empty($_POST['RegCurso'])) 
			  {
               if(empty($_POST['DNI'])) 
				{ ?>
			       <div class="row">
                    <div class="col-lg-12"><div class="alert alert-dismissible alert-danger"><strong>Primero debe seleccionar un estudiante</strong></div></div>
			  ...
			  else 
				{
                  ...
                  $_POST['Curso'] = $EstudianteBuscado['CURSO'];
					...
					<div class="row" align="center"><font color="#85C1E9">
					 ...
					 </div><!-- primera linea-->	<hr> 
					 <div class="row">
					  <div class="form-group">
                        <div class="col-lg-6"><label>Apellido *</label><input class="form-control" name="Apellido" value="<?php echo !empty($_POST['Apellido']) ? $_POST['Apellido'] : ''; ?>" readonly></div>
						<div class="col-lg-6"><label>Nombre *</label><input class="form-control" name="Nombre" value="<?php echo !empty($_POST['Nombre']) ? $_POST['Nombre'] : ''; ?>" readonly></div>
				      </div>
					 </div><!-- segunda linea--> <hr>
					  <div class="row">
					  <div class="form-group">
                        <div class="col-lg-6"><label>Dni *</label><input class="form-control" name="DNI" value="<?php echo !empty($_POST['DNI']) ? $_POST['DNI'] : ''; ?>" readonly></div>
						<div class="col-lg-6"><label>Teléfono * </label><input class="form-control" name="telefono" value="<?php echo !empty($_POST['telefono']) ? $_POST['telefono'] : ''; ?>" readonly></div>
				      </div>
					 </div><!-- tercera linea--><hr>
					 <div class="row">
					  <div class="form-group">
					 ...
					 <div class="row">
					  <div class="form-group">
						...
						<div class="col-lg-6"><label>Nacionalidad *</label>
					  ...
					  <div class="form-group">
						...
						<div class="col-lg-6"><label>Barrio*</label>
					  ...
					  <div class="row">
					  <div class="form-group">
                        <div class="col-lg-6"><label>Fecha de Nacimiento * </label>
                                            <input id="date" type="date" name="fechaNacim" value="<?php echo !empty($_POST['fechaNacim']) ? $_POST['fechaNacim'] : ''; ?>" readonly></div>
						<div class="col-lg-6"><label>Fecha de Preinscripcion </label>
                                            <input id="date" type="date" name="fechaPreinscripcion" value="<?php echo !empty($_POST['fechaPreinscripcion']) ? $_POST['fechaPreinscripcion'] : ''; ?>" readonly></div>
						</div>
					 </div><!-- septima linea--><hr>
					  <div class="row">
					  ...
					  <div class="row">
					  <div class="form-group">
                        <div class="col-lg-1"><label>Curso</label></div>
						...
						<div class="col-lg-4"><label></label> <button type="submit" class="btn btn-primary" value="RegCurso" name="RegCurso"><box-icon  name="edit" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Registrar Curso Actual</button></div>
						</div>
					 </div><!-- novena linea--><hr>
