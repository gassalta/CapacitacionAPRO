...
?>
  <div id="page-wrapper">
    <div class="row">
	  <div class="col-lg-10"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Modificar un Curso</b></font></h2></div>
    </div><!-- /.row titulo-->
    <div class="row">
      <div class="col-lg-10">
       <div class="panel panel-primary">
         <div class="panel-heading">Datos Curso N°<?php echo $idCurso;?></div>
...
<?php
            ...
            <div class="row" align="center">
			  ...
			  <div class="col-lg-4">
			     <button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar"onClick="return confirm ('Seguro que desea guardar los cambios del Curso?');"><box-icon  name="check-double" type="solid" size="sm" color="white" animation="tada-hover"></box-icon>Confirmar</button>
              </div>     
			  <div class="col-lg-4">
