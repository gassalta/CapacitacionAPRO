...
?>
			...
			<td colspan="5" align="left"><Form Action="Aprendizajes.php?Cx=<?php echo $Cont; ?>&Cn=<?php echo $Contenido; ?>&Ec=<?php echo $EspacioCurricular; ?>" Method="Post"><button type="submit" class="btn btn-primary" value="Cancelar" name="Cancelar" ><box-icon name="x" type="solid" size="md" color="white" animation="tada-hover"></box-icon>Cancelar</button></td>
			</table>
          </div>
        </div>
    </div>
