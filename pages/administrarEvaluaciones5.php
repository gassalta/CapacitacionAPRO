							...
							if ($_SESSION['Categoria']!=='Coordinador/a')
								...
								if ($EC==$ListadoEC[$i]['NOMBREESPACCURRIC'])
                                    ...
                                    echo"</option>";
                                       ...
                                       ><box-icon  name="show-alt" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Ver</button></diV>
                                        </div>
										</div><!--fin row 1--><hr>
...
?>
                                 <tr>
									...
									<?php                                    
									echo'<td><a href="buscarUnaEvaluacion.php?Tx=M&Cx='.$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC.'"><box-icon name="search-alt"  size="md" color="#005eff" animation="tada-hover"></box-icon></a></td>';
                                if ($_SESSION['Categoria'] == 'Docente' || $EC != '')
									{
									 ...
									 ?>
									<td><button class="btn btn-danger btn-circle" type="submit"  name="eliminar" formaction="eliminarEvaluacion.php?Cx=<?php echo$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC ?>" onclick="return confirm ('¿Seguro que desea eliminarlo?')"><box-icon  name="trash"  size="md" color="white" animation="tada-hover"></box-icon></button></td>
									  <?php
									/*echo'<td><a href="eliminarEvaluacion.php?Tx=M&Cx='.$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC.'"><box-icon name="trash" " size="md" color="#005eff"  animation="tada-hover"></box-icon></a></td>';*/
                                    }
								echo'</tr> ';
								}
 ?>
      ...
      <?php }
                    ...
                    <div class="row">
						<div class="col-lg-12"><div class="bs-component"><div class="alert alert-dismissible alert-success"><strong><center>Seleccione un espacio curricular</center></strong></div></div></div>
					</div>
      <?php  }?>
	    <br>
 ...
 ?>	  
	          <div class="row" align="center">
				...
				<div class="col-lg-4"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar"formaction="index.php"><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar</button></div></div></div>
 <?php 
			}
		  else
		   {  	   
?>
				...
				<div class="col-lg-4"></div>
				 <div class="col-lg-4"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar"formaction="index.php"><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada"></box-icon> Retornar</button></div></div>
 <?php 
			}
?>		
                        </div> <!-- /.panel-body -->
