...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-10"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Registros Anuales de Calificaciones</b></font></h2>  </div></div><br>
  </div>  <!-- /.row titulo -->
  <div class="row">
   <div class="col-lg-10">
...
?>
    ...
    <hr>
		...
		<div class="row" align="center">
			...
			<div class="col-lg-12">  
				<button type="submit" class="btn btn-primary" value="EmitirRACs" name="EmitirRACs" ><box-icon  type='solid' name='user-detail'  size="sm" color="white" animation="tada-hover"></box-icon> Emitir Registros Anuales de Calificaciones de los Estudiantes del Curso</button>
			  </div></div>
         <hr>
         <?php
            ...
            $CantidadEstudiantes = count($ListadoEstudiantes);
             ...
             <?php
                ...
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Algunos RACs listos. Presione "Continuar"</center></strong>
                </div>
              </div>
                                                    <?php
                } else{
                ...
                ?>
                                                            <div class="bs-component">
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Todos los RACs se generaron y están listos para su descarga</center></strong>
                </div>
              </div>
                                                    <?php
                $Emitidas = 1;
      ...
      if (!empty($_POST['Continuar1'])) {
        ...
        $_SESSION['dostercios'] = $_SESSION['tercioCantEst']*2;
                ...
                ?>
                                                            <div class="bs-component">
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Se generaron algunos RACs más. Vuelva a presionar "Continuar"</center></strong>
                </div>
              </div>
                                                    <?php
      }
      ...
      if (!empty($_POST['Continuar2'])) {
        ...
        for ($i=$_SESSION['dostercios']; $i < $CantidadEstudiantes; $i++) { 
          ...
          if ($Emitidas == 1) {
            ...
            <div class="row" align="center">
              <div class="col-lg-12">  
        <button type="submit" class="btn btn-primary" value="DescargarLibretas" name="DescargarLibretas" ><box-icon  type='solid' name='download'  size="sm" color="white" animation="tada-hover"></box-icon> Descargar Registros Anuales de Calificaciones</button>
        </div></div>
         <hr>
            <?php
          }
