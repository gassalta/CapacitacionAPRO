			...
			<div class="row">
				<div class="col-lg-10">
					<div class="tile">
						<h2 class="tile-title">
							<font color="#85C1E9">
								<center><b>Informaci&oacuten del docente</b>
							</font>
						</h2>
					</div>
				</div><br>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<form role="form" method="post">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group"><label for="disabledSelect">Apellido y Nombre</label><input class="form-control" name="Apellido" value="<?php echo !empty($_POST['Apellido']) ? $_POST['Apellido'] : '';
																																										echo ', ';
																																										echo !empty($_POST['Nombre']) ? $_POST['Nombre'] : ''; ?>" readonly></div>
									</div>
									<div class="col-lg-3">
										<div class="form-group"><label for="disabledSelect">DNI</label><input class="form-control" name="DNI" value="<?php echo !empty($_POST['DNI']) ? $_POST['DNI'] : ''; ?>" readonly> </div>
									</div>
									<div class="col-lg-3">
										<div class="form-group"><label for="disabledSelect">Legajo en Junta</label><input class="form-control" name="NroLegajoJunta" value="<?php echo !empty($_POST['NroLegajoJunta']) ? $_POST['NroLegajoJunta'] : ''; ?>" readonly></div>
									</div>
								</div><!-- fin primera row--><br>
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group"><label for="disabledSelect">E-mail</label><input class="form-control" name="Mail" value="<?php echo !empty($_POST['Mail']) ? $_POST['Mail'] : ''; ?>" readonly></div>
									</div>
									<div class="col-lg-6">
										<div class="form-group"><label for="disabledSelect">Título</label><textarea class="form-control" rows="1" name="Titulo" readonly><?php echo !empty($_POST['Titulo']) ? $_POST['Titulo'] : ''; ?></textarea></div>
									</div>
								</div><!-- fin segunda row--><br>
								<div class="row" align="center">
									<div class="form-group">
										<div class="col-lg-4"><label for="disabledSelect">Fecha de Nacimiento </label><input class="form-control" id="date" type="date" name="FechaNacim" value="<?php echo !empty($_POST['FechaNacim']) ? $_POST['FechaNacim'] : ''; ?>" readonly></div>
										...
										<div class="col-lg-4"><label for="disabledSelect">Fecha de Escalafón </label><input class="form-control" id="date" type="date" name="FechaEscalafon" value="<?php echo !empty($_POST['FechaEscalafon']) ? $_POST['FechaEscalafon'] : ''; ?>" readonly></div>
									</div>
								...
								<div class="row" align="center">
									...
									<div class="col-lg-4">
										<div class="panel panel-info">
											<div class="panel-heading">
												<center><b>Espacio Curriculares</b></center>
											</div>
											<div class="panel-body">
												<ul>
													<?php
									...
									<div class="col-lg-3">
										<div class="form-group">
											<div class="panel panel-info">
												...
												<div class="panel-body" <div class="row" align="center">
													<div class="col-lg-12"><b> <?php if ($DocenteBuscado['CATEGORIA'] == 1) {
																					echo 'Cordinador/a';
																				} elseif ($DocenteBuscado['CATEGORIA'] == 2) {
																					echo 'Secretario/a';
																				} elseif ($DocenteBuscado['CATEGORIA'] == 3) {
																					echo 'Preceptor/a';
																				} else {
																					echo 'Docente';
																				}  ?></b></div>
