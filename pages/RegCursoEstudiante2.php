...
<?php
 ...
 <div id="page-wrapper">
   ...
   <div class="col-lg-2"></diV>
    <div class="col-lg-6"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Estudiante <?php echo $Estudiante['APELLIDO'];echo ", ";  echo $Estudiante['NOMBRE']; ?></b></font></h2>  </div></div><br>
   </div>  <!-- /.row titulo --><br>
   <div class="row">
    <div class="col-lg-2"></diV>
    <div class="col-lg-6">
     <div class="panel panel-primary">
       <div class="panel-heading">Seleccione un curso</div>
...
?>
 ...
 <?php
				    ...
				    {
?>
					 <div class="alert alert-dismissible alert-danger"><strong><center>El curso seleccionado es el que ya se encuentra registrado</center></strong></div>
...
<?php
				  ...
				  {
 ?>
                    <div class="alert alert-dismissible alert-danger"><strong><center>Debe seleccionar un curso</center></strong></div>
...
?>
			...
			</div>  <!--fin row radios-->   <hr>
            <div class="row"align="center">
			<div class="col-lg-2"> </div>
              <div class="col-lg-4"><button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('Seguro que desea guardar el curso actual del estudiante?');"> <box-icon  name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon> Confirmar</button></div>
