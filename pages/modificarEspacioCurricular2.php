...
?>
         ...
         <div class="panel-heading"><center><b>Cursos en los que se dicta</b></center></div>
          <div class="panel-body">
				       <div class="form-group">
								...
								/*	if($CantEspCurricular==0)
									...
									?>	  
										  <div class="radio">
                                                <label>
                                                    <input type="radio" name="curso" id="curso" value="0" <?php echo ($TieneCurso == 0) ? 'checked' : '';?>><font color="red">No se dicta en ningún curso</font>
                                                </label>
											</div>
            ...
            <div class="row" align="center">
			  ...
			  <div class="col-lg-4">
			    <button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar"><box-icon  name="x" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Cancelar</button>
			  </div>
			</diV>  
