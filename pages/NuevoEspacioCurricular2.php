				...
				<div class="row">
                  <div class="col-lg-6">  
                    <div class="form-group">
                        <label>Nombre Espacio Curricular *</label><input class="form-control" name="NombreEspCurr" value="<?php echo !empty($_POST['NombreEspCurr']) ? $_POST['NombreEspCurr'] : ''; ?>">
                    </div>
				   </div>
				  <div class="col-lg-6">  					
                    <div class="form-group">
...
?>
					   ...
					   <button type="submit" class="btn btn-primary" value="AreaNuevo" name="AreaNuevo" formaction="NuevoArea.php"><box-icon  name="plus"  size="sm" color="white" animation="tada-hover"></box-icon> Agregar área</button>
                    </div>
				   </div>
				</div><!-- /.row input --><br>
