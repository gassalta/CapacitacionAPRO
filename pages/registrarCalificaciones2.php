...
?>
    <div class="panel panel-primary">
     <div class="panel-heading"><center><?php  echo'Fecha de evaluación: '.$nuevaFecha; ?> </center></div><br><br>
...
?>
		...
		<div class="col-lg-1"></div>
           <div class="col-lg-4"><label>Estudiante <?php echo ($_SESSION['Categoria']=='Docente' || ($EsDocente == 1 && $EC != "")) ? 'a calificar' : ''; ?> </label></div>
...
?>
                <div class="row">
                  <div class="col-lg-2"><div class="form-group"><label><?php echo $aprendizajesEst[$i]['CONTENIDO']; ?></label> </div></div>
                  <div class="col-lg-8"><div class="form-group"><?php echo $aprendizajesEst[$i]['DENOMINACION']; ?> </div></div>
                  <div class="col-lg-2"><div class="form-group"><div class="checkbox"><label><input type="checkbox" name="<?php echo $aprendizajesEst[$i]['ID']; ?>" value="SI" <?php echo ($aprendizajesEst[$i]['LOGOPEND'] == 1) ? 'checked' : ''; ?> <?php echo ($_SESSION['Categoria']!='Docente' && ($EsDocente!=1 || $EC == "")) ? 'disabled' : ''; ?>/></label></div></div></div><br>
...
?>
							</div> <!--fin panel body secundaria-->
							</div><!--fin panel secundaria-->
...
?>  
				  ...
				  <div class="col-lg-2"><label><b>Calificación :</b> </label></div>
				   <div class="col-lg-4"><input class="form-control" name="Calificacion" value="<?php echo !empty($_POST['Calificacion']) ? $_POST['Calificacion'] : ''; ?>" <?php echo ($_SESSION['Categoria']!='Docente' && $EsDocente!=1) ? 'readonly' : ''; ?>></div></b>
                 </div></div><br>
...
?>
                   ...
                   <div class="col-lg-4"></div>
                            <div class="col-lg-4"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar" onClick="return confirm ('¿Desea cancelar? - Se perderán los datos que no haya guardado');"><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar</button></div> <br></div>
<?php  
                        }
                    else 
                      { 
 ?>
                   ...
                   <div class="col-lg-4"></div>
                         <div class="col-lg-2"> </div> 
                        <div class="col-lg-4"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar" ><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada"></box-icon> Retornar</button></div> <br></center></div>
<?php 
                        }
                        ?>
                    </div> </center></div> <br>
