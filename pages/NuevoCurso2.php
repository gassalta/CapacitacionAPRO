...
?>
  <div id="page-wrapper">
    <div class="row">
      <div class="col-lg-12"><div class="col-lg-12"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Nuevo Curso</b></font></h2></div></div>
    </div><!-- /.row titulo-->
    <div class="row">
       <div class="col-lg-12">
          <div class="panel panel-primary">
             <div class="panel-heading">Complete los datos</div>
		...
		?>
                ...
                <div class="row" align="center">
                 ...
                 <div class="row" align="center">
				  ...
				  <div class="col-lg-3"> <button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('Seguro que desea guardar el nuevo Curso?');"><box-icon  name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon> Confirmar</button></div>
