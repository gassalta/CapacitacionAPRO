...
<div id="page-wrapper">
   ...
   <div class="row" align="center">
      <div class="col-lg-8"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Registrar un Área nueva</b></font></h2>  </div></div>
    </div> <!-- /.row titulo --><br>
    <div class="row">
    <div class="col-lg-8">
...
?>
			...
			<div class="col-lg-3"><label>Ingrese el nombre del  Área </label></div>
             <div class="col-lg-7 ">
            <input class="form-control" name="Denominacion" value="<?php echo !empty($_POST['Denominacion']) ? $_POST['Denominacion'] : ''; ?>"></div>  
			 </div>  
			 </div><!--fin row area--><br><br>
              <div class="row" align="center">
