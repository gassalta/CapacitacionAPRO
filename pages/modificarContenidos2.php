   ...
   <div class="row">
     <div class="col-lg-10">
       <div class="panel panel-primary">
         <div class="panel-heading">Datos del Contenido N° <?php echo $IdContenido;?></div>
...
<?php 
 ...
 ?>
                             <div class="bs-component"><div class="alert alert-dismissible alert-success"><strong><center>¡El contenido número <?php echo $_SESSION['IdContenidoElegido']; ?> se modif&oacute correctamente!</center></strong> </div> </div>
<?php    
							}
                        }
					 else 
                                      ...
                                      <!--   <div class="form-group">          
                                       ...
                                       ><box-icon  name="search-alt" type="solid" size="sm" color="white" animation="tada-hover"></box-icon>Buscar</button> 
										...
										<div class="col-lg-2"></div>
									     <div class="col-lg-4">
									  	 <button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('¿Seguro que desea guardar el nuevo contenido?');"><box-icon  name="check-double" type="solid" size="sm" color="white" animation="tada-hover"></box-icon>Confirmar</button></div>
									   	<div class="col-lg-4">
