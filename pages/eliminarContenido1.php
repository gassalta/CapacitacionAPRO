            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post">
                                        <?php 
                                            //Si confirma verifico acceso al contenido
                                            ...
                                            /*    if ($_SESSION['IdContenidoElegido'] == "") {
                                                ...
                                                //Si está todo bien elimino el contenido en base de datos, sino, muestro mensaje
                                                if ($mensaje == '') {
                                                    $mensaje = eliminarElContenido($MiConexion,$_SESSION['IdContenidoElegido']);
                                                    ?>
             <?php
                                            $_POST['EspaCurri'] ="";
                                            $_POST['Denominacion'] = "";
             ...
             <?php
                                   ...
                                   /*    if (!empty($_POST['Buscar'])) {
                                                ...
                                                $ContenidoBuscado = buscarContenido($MiConexion,$_POST['Id']);
                                                $Cant = count($ContenidoBuscado);
                                                $_SESSION['IdContenidoElegido'] = $_POST['Id'];
                                          ...
                                          <?php   
                                            ...
                                            $_SESSION['IdContenidoElegido'] = "";
                                                    ...
                                                    for ($i=0; $i < $CantidadEspCurr; $i++) { 
                                                        if ($ContenidoBuscado['ESPACCURRIC'] == $ListadoEC[$i]['NOMBREESPACCURRIC']) {
                                                            $ok = 1;
                                                        }
                                                    }
                                                    //Si corresponde...
                                                    if ($ok == 1) {
                                                        ...
                                                        $_POST['EspaCurri'] = $ContenidoBuscado['IDESPCUR'];*/
                                      ...
                                      <div class="form-group">          
                                       ...
                                       ><box-icon  name="search-alt" type="solid" size="sm" color="white" animation="tada-hover"></box-icon>Buscar</button> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="Denominacion" value="<?php echo !empty($_POST['Denominacion']) ? $_POST['Denominacion'] : ''; ?>" readonly>
                                        </div>
                                        
									  
												<button type="submit" class="btn btn-default" value="Confirmar" name="Confirmar" style="background-color: #337ab7; color: white;"
                                            onClick="return confirm ('Seguro que desea eliminar el contenido? - No podrá recuperar la información eliminada');"
