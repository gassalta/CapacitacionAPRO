...
<div id="page-wrapper">
   <div class="row">
          <div class="col-lg-10"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Consulta de Aprendizajes</b></font></h2></div></div>
    </div><!-- /.row titulo--><br>
  ...
  <div class="row">
    <div class="col-lg-10">
        <div class="panel panel-primary">
          <div class="panel-heading">Aprendizajes por Espacio Curricular</div><br>
...
<?php 
 ...
 <?php
					...
					<div class="col-lg-2">
                        <button type="submit" class="btn btn-default" value="Ver" name="Ver" style="background-color: #337ab7; color: white;"><box-icon  name="show-alt" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Ver</button>
					</div>
				</div><br><hr>
...
?>
                                <div class="row">
									<div class="col-lg-12"><div class="alert alert-dismissible alert-danger"><strong><center>El espacio curricular seleccionado no tiene aprendizajes registrados</center></strong></div></diV>
								</div>
 <?php
                                 } 
							} 
...
<?php      
				...
				<div class="row" align="center">
                  <div class="col-lg-12">
                    <label><font color="#85C1E9" size="3px"><center><b><?php echo $EspCurrElegido['NOMBREESPACCURRIC']."    -     Año: ".$EspCurrElegido['ANIO']; ?></b></center></font></label>
				</div>
				</div><!--row titulo-->
...
?> 
                 ...
                 <div class="row" align="center">
                    ...
                    <div class="col-lg-4">
                       <button type="submit" class="btn btn-default" value="Emitir" name="Emitir" style="background-color: #337ab7; color: white;" formaction="funciones/emitirPDFListadoAprendizajesXEspCurr.php"onClick="return confirm ('Seguro que desea emitir el informe?');"><box-icon  name="downvote" type="solid" size="sm" color="white" animation="fade-down"></box-icon> Emitir listado </button>
					</div>
					<div class="col-lg-4">
                        <button class="btn btn-danger" type="submit" name="Cancelar" formaction="index.php" onclick="return confirm ('¿Seguro que desea cancelar?')"><box-icon  name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar</button>
					</div>
					</div><!--row botones-->
