  ...
  <div class="row">
    <div class="col-lg-10">
     <div class="panel panel-primary">
      <div class="panel-heading"><font color="white" size="3px"><center>¿ Qué aprendizaje evaluará el día <?php  echo $nuevaFecha ?> ?</center></font></div><br><br>
...
<?php
		  ...
		  if ($CantAXEC==0)//Si no tiene aprendizajes el EC
			{ 
?>
              <div class="row">
			   ...
			   </div> <!-- fin row aviso  --><br><br>
			  <div class="row" align="center">
				<div class="col-lg-2"></div>
				<div class="col-lg-4"><button type="submit" class="btn btn-primary" value="Aprendizajes" name="Aprendizajes" ><box-icon name="plus-circle" type="solid" size="sm" color="white" animation="tada"></box-icon> Registrar Aprendizaje</button></div>
...
<?php
		  ...
		  else //Si tiene aprendizajes el EC
		    { 
?>  
...
?>
                    <label><input type="checkbox" name="<?php echo $ListadoAprendizajesXEC[$i]['ID']; ?>" value="SI" <?php echo ($EsDeEval == 1) ? 'checked' : ''; ?>> <?php echo $ListadoAprendizajesXEC[$i]['DENOMINACION']; ?></label><br><br>
 <?php      
					if($Evaluado == 1)
					  { 
?>
...
?>
				...
				</div> <!-- fin col chexkbox -->
				</diV><!-- fin row checkbox --><br><br>
			   <div class="row" align="center" >
				<div class="col-lg-2"></div>
				<div class="col-lg-4"><button type="submit" class="btn btn-primary" value="Confirmar" name="Confirmar" onClick="return confirm ('¿Desea guardar el la evaluación los aprendizajes seleccionados?');"><box-icon name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon> Confirmar</button></div>
				<div class="col-lg-4"><button type="submit" class="btn btn-danger" value="Cancelar" name="Cancelar"><box-icon name="arrow-back" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Retornar</button><div></div></div>										
               </div> <!-- fin row botones --><br><br>
			</div>    <!-- fin form group-->
			<div class="row" align="center">
				<div class="col-lg-12"><div class="alert alert-dismissible alert-info"><strong><center>Los aprendizajes de <font color="red"> color rojo </font>ya han sido evaluados.</center></strong></div></div>
			</div>
		  <?php
		  }
		  ?>
