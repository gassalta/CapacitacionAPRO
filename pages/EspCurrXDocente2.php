			...
			<div class="col-lg-3"></div>
                <div class="col-lg-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading"><h4><center>Seleccione los Espacios Curriculares </h4> </div>
                ...
                <div class="alert alert-dismissible alert-success">
                  <strong>Ya no hay docente a cargo de <?php echo $ListadoEspCurricular[$i]['NOMBREESPACCURRIC']; ?></strong>
								...
								<div class="col-lg-4">
                                       ...
                                       ><box-icon name="check-double" type="solid" size="sm" color="white" animation="tada"></box-icon> Modificar</button></div>
