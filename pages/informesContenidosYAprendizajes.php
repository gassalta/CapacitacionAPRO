...
<div id="page-wrapper">
  <div class="row"align="center">
    <div class="col-lg-10"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Informes de Contenidos y Aprendizajes</b></font>    </center></h2>  </div></div>
  </div>  <!-- /.row titulo --><br>
  <div class="row">
...
?>
    ...
    </div><!-- row busqueda--><br><hr>
		
		<div class="row" align="center">
		 
			<div class="col-lg-12">  
				<button type="submit" class="btn btn-primary" value="EmitiInformes" name="EmitirInformes" ><box-icon  type='solid' name='user-detail'  size="sm" color="white" animation="tada"></box-icon> Emitir Informes de Contenidos y Aprendizajes de los Estudiantes del Curso</button>
			  </div></div>
         <br><br>
         <?php
            ...
            if (empty($_POST['Curso'])) {
              ?>
                <div class="alert alert-dismissible alert-danger">
                  <strong><center>Debe seleccionar un curso</center></strong>
                </div>
             <?php
            } else {
              if (empty($_POST['Etapa'])) {
                ?>
                <div class="alert alert-dismissible alert-danger">
                  <strong><center>Debe seleccionar una etapa</center></strong>
                </div>
             <?php
              } else {
    ...
    unlink($file); //elimino el fichero
            ...
            $CantidadEstudiantes = count($ListadoEstudiantes);
              if ($CantidadEstudiantes == 0) {
                                        ?>
                <div class="alert alert-dismissible alert-danger">
                  <strong><center>El curso seleccionado no tiene estudiantes asignados</center></strong>
                </div>
             <?php
              } else {
                ...
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Algunos informes listos. Presione "Continuar"</center></strong>
                </div>
              </div>
                                                    <?php
                } else {
                ...
                ?>
                                                            <div class="bs-component">
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Todos los informes se generaron y están listos para su descarga</center></strong>
                </div>
              </div>
                                                    <?php
                $Emitidas = 1;
      ...
      <div class="col-lg-12">  
        <button type="submit" class="btn btn-primary" value="Continuar1" name="Continuar1" ><box-icon  type='solid' name='user-detail'  size="sm" color="white" animation="tada"></box-icon> Continuar</button>
        </div></div>
         <br><br>
      <?php  }
      if (!empty($_POST['Continuar1'])) {
        ...
        $_SESSION['dostercios'] = $_SESSION['tercioCantEst']*2;
                ...
                ?>
                                                            <div class="bs-component">
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Se generaron algunos informes más. Vuelva a presionar "Continuar"</center></strong>
                </div>
              </div>
                                                    <?php
      }
      ...
      <div class="col-lg-12">  
        <button type="submit" class="btn btn-primary" value="Continuar2" name="Continuar2" ><box-icon  type='solid' name='user-detail'  size="sm" color="white" animation="tada"></box-icon> Continuar</button>
        </div></div>
         <br><br>
      <?php  }
      if (!empty($_POST['Continuar2'])) {
        ...
        for ($i=$_SESSION['dostercios']; $i < $CantidadEstudiantes; $i++) { 
          ...
          if ($Emitidas == 1) {
            ...
            <div class="row" align="center">
              <div class="col-lg-12">  
        <button type="submit" class="btn btn-primary" value="DescargarInformes" name="DescargarInformes" ><box-icon  type='solid' name='downvote'  size="sm" color="white" animation="fade-down"></box-icon> Descargar Informes</button>
        </div></div>
         <br><br>
            <?php
          }
