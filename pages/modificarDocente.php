      ...
      <div class="row">
        <div class="col-lg-10">
          <div class="tile">
            <h2 class="tile-title">
              <font color="#85C1E9">
                <center><b>Modificar informaci&oacuten del docente</b>
              </font>
            </h2>
          </div>
        </div><br>
        ...
        <div class="col-lg-10">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <center>Docente N° <?php echo $IdDocente ?></center>
            </div>
            <div class="panel-body">
              <form role="form" method="post">
                        ...
                        <div class="col-lg-12">
                          <div class="bs-component">
                            <div class="alert alert-dismissible alert-success"><strong>
                                <center>¡ Docente número <?php echo $_SESSION['IdDElegido']; ?> modificado correctamente !</center>
                              </strong> </div>
                          </div>
                        </div>
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-group"><label>Apellido *</label><input class="form-control" name="Apellido" value="<?php echo !empty($_POST['Apellido']) ? $_POST['Apellido'] : ''; ?>"></div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group"><label>Nombre *</label><input class="form-control" name="Nombre" value="<?php echo !empty($_POST['Nombre']) ? $_POST['Nombre'] : ''; ?>"></div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group"><label>D.N.I *</label><input class="form-control" name="DNI" value="<?php echo !empty($_POST['DNI']) ? $_POST['DNI'] : ''; ?>"> </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group"><label>Legajo en Junta</label><input class="form-control" name="NroLegajoJunta" value="<?php echo !empty($_POST['NroLegajoJunta']) ? $_POST['NroLegajoJunta'] : ''; ?>"></div>
                  </div>
                </div><!-- fin primera row--><br>

                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group"><label>E-mail *</label><input class="form-control" name="Mail" value="<?php echo !empty($_POST['Mail']) ? $_POST['Mail'] : ''; ?>"></div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group"><label>Título *</label><select class="form-control" name="Titulo" id="Titulo">
                ...
                <div class="row" align="center">
                  <div class="col-lg-3" align="left">
                    ...
                    <div class="panel panel-info">
                      <div class="panel-heading">
                        <center><label>Categoría *</center></label>
                      </div>
                    ...
                    </div><!-- fin panel info categoria row-->
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group"><label>Fecha de Nacimiento *</label><input class="form-control" id="date" type="date" name="FechaNacim" value="<?php echo !empty($_POST['FechaNacim']) ? $_POST['FechaNacim'] : ''; ?>"></div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group"><label>Fecha de Escalafón</label><input class="form-control" id="date" type="date" name="FechaEscalafon" value="<?php echo !empty($_POST['FechaEscalafon']) ? $_POST['FechaEscalafon'] : ''; ?>"></div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-3"><label for="disabledSelect">Último Ingreso</label><input class="form-control" id="disabledInput" type="text" disabled name="UltIngreso" value="<?php echo !empty($_POST['UltIngreso']) ? $_POST['UltIngreso'] : ''; ?>"></div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="bs-component">
                      <div class="alert alert-dismissible alert-info"><strong>
                          <center>Los campos marcados (*) son obligatorios</center>
                        </strong> </div>
                    </div>
                  </div>
