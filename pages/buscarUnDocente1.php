...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><font color="#85C1E9"><center>Búsqueda de docentes</center></font></h1>
                </div>
       ...
       <!-- <div class="clearfix"></div>-->
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                           <!--  <h3 align="center"><box-icon class="border border-secondary border-3 rounded-circle" name="search-alt"  size="lg" color="white" ></box-icon>  Búsqueda de docentes </h3>-->
                        </div>
                  ...
                  <strong>Número de docente no válido</strong>
                                          ...
                                          <?php      } else {
                                            ...
                                            if(!empty($_POST['EspCurr'])) {
                                                if (empty($_POST['DNI'])) { ?>
                                                    <div class="alert alert-dismissible alert-danger">
                  <strong>Primero debe seleccionar un docente</strong>
              </div>
                                               <?php } else {
								    ...
								    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="Apellido" 
                                                value="<?php echo !empty($_POST['Apellido']) ? $_POST['Apellido'] : ''; ?>" readonly>
                                        </div></div>
										<div class="col-lg-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="NroLegajoJunta" value="<?php echo !empty($_POST['NroLegajoJunta']) ? $_POST['NroLegajoJunta'] : ''; ?>" readonly>
                                        </div></div></div>
										 <div class="row">
                                         <div class="col-lg-12">
										 <div class="form-group">
										...
										<div class="form-group">
										 ...
										 <div class="form-group">
                                            ...
                                            <input id="date" type="date" name="FechaEscalafon" value="<?php echo !empty($_POST['FechaEscalafon']) ? $_POST['FechaEscalafon'] : ''; ?>" readonly>
                                        </div></div></div>
										<div class="row">
                                         <div class="col-lg-9">
										<div class="form-group">
                                            <label for="disabledSelect">Título</label>
                                            <textarea class="form-control" rows="2" name="Titulo" readonly><?php echo !empty($_POST['Titulo']) ? $_POST['Titulo'] : ''; ?></textarea>
                                        </div></div>
										 <div class="col-lg-3">
										<div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                                <label class="radio-inline" for="disabledSelect">
                                                    <input type="radio" name="categorias" id="1" value="1" <?php echo (!empty($_POST['categorias'])) && ($_POST['categorias']=='1') ? 'checked':''; ?> readonly>Coordinador/a
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label class="radio-inline" for="disabledSelect">
