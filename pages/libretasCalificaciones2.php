            ...
            $CantidadEstudiantes = count($ListadoEstudiantes);
             ...
             <?php
                ...
                <div class="alert alert-dismissible alert-success">
                  <strong><center>Las libretas se generaron y están listas para su descarga</center></strong>
                </div>
              </div>
                                                    <?php
                $Emitidas = 1;
    ...
    <div class="row">
      ...
      <select class="form-control" name="Etapa" id="Etapa">
		...
		<div class="row" align="center">
			...
			<div class="col-lg-12">  
				<button type="submit" class="btn btn-primary" value="EmitiLibretas" name="EmitirLibretas" ><box-icon  type='solid' name='user-detail'  size="sm" color="white" animation="tada-hover"></box-icon> Emitir Libretas de Calificaciones de los Estudiantes del Curso</button>
			  </div></div>
         <hr>
         <?php
          if ($Emitidas == 1) {
            ...
            <div class="row" align="center">
              <div class="col-lg-12">  
        <button type="submit" class="btn btn-primary" value="DescargarLibretas" name="DescargarLibretas" ><box-icon  type='solid' name='download'  size="sm" color="white" animation="tada-hover"></box-icon> Descargar Libretas</button>
        </div></div>
         <hr>
            <?php
          }
