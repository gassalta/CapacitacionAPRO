...
<?php 
        ...
        $ListadoEstudiantes = ListarEstudiatesReprobados($MiConexion,$EvaluacionBuscada['IDESPACURRI']);
...
?>
    <div class="panel panel-primary">
     <div class="panel-heading"><center><?php  echo'Coloquio - Fecha de evaluación: '.$nuevaFecha; ?> </center></div><br><br>
