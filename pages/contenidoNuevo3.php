     ...
     <div class="row">
       <div class="col-lg-10">
         <div class="panel panel-primary">
           <div class="panel-heading"><center> Ingrese el nombre del nuevo contenido </div>
...
?>
					...
					<div 	class="col-lg-6"><label>Contenido</label>
					...
					<div class="row" align="center">
									   ...
									   <div class="col-lg-4">
										...
										<div class="col-lg-4"><button class="btn btn-danger" type="submit" name="Cancelar" formaction="administrarContenidosYAprendizajes.php?Cx=<?php echo $EC; ?>"><box-icon  name="x" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Cancelar</button></div>
