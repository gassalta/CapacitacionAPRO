...
?>
	<div id="page-wrapper">
	<div class="row">
	  <div class="col-lg-12"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Listado Aprendizajes de <?php echo '"'.$NContenido.'"'; ?></b></font></h2>  </div></div>
	  </div><br>
     <div class="row">
        <div class="col-lg-12">
...
?>
					 <tr>
					 <td colspan="6"><b><a <?php echo'href="ModificarAprendizaje.php?Tx=A&Cx='.$Contenido.'&Ec='.$EspacioCurricular.'"><box-icon  name="plus-circle" type="solid" size="md"  color="#005eff" animation="tada-hover"></box-icon> Registrar un nuevo Apendizaje</b></a></td></tr>';
				}
...
?>
			...
			<div class="row" align="center">
			 ...
			 <form name="contact"  action="administrarContenidosYAprendizajes.php?Cx=<?php echo $EspacioCurricular;?> "method="post">
						<button type="submit" class="btn btn-primary">Otra consulta <box-icon name="question-mark" type="solid" size="md" color="white" animation="tada"></box-icon></button></form>
						</div></div>
