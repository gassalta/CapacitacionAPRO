...
<?php
			echo'<td><a href="buscarUnDocente.php?Cx='.$Listado[$i]['ID'].'"><box-icon  name="show-alt"  size="md" color="#005eff" animation="tada-hover"></box-icon><b></a></td> ';
...
?>
			<tr>
			 <td colspan="9"><b><a href="DocenteNuevo.php"><box-icon  name="plus-circle" type="solid" size="md""  color="#005eff" animation="tada-hover"></box-icon> Agregar un nuevo Docente</b></a></td>
			</tr>
