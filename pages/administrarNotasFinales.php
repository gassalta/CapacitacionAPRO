...
?>
 <div id="page-wrapper">
  <div class="row">
    <div class="col-lg-10"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Calificaciones Finales </b></font></h2></div>
	   ...
	   <div class="panel-body">
        <form role="form" method="post">
		  <div class="form-group">
			...
			<div class="col-lg-6"><select class="form-control" name="EspCurr" id="EspCurr"> 
				<?php
				$EC=$_REQUEST['Cx'];
				if ($EC == "") { ?>
					<option value=""></option>
...
?>
			...
			<div class="col-lg-2"><button type="submit" class="btn btn-primary" value="ElegirEspCurricular" name="ElegirEspCurricular"><box-icon  name="show-alt" type="solid" size="sm" color="white" animation="tada"></box-icon> Ver</button></div>
			</div><!--fin row1--><br>		
...
<?php 
		...
		for ($i=0; $i < $CantTodosEst; $i++) 
		  { 
			...
			if($_SESSION['Categoria']=='Docente'|| $EsDocente==1)
			  {
				echo'  <tr><td><a href="NotasFinalesXEstudiante.php?Cx='.$IdEstudiante.'&Cn='.$EC.'&Ca='.$Calificacion.'"><box-icon  name="edit-alt" type="solid" size="md" color="#005eff" animation="spin-hover"></box-icon></a></td><td><b> '.$ApellidoEstudiante.'</b>,'.$NombreEstudiante.'</td>';
			  }
			else 
			  {
