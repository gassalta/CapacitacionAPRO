            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <form name="buscarxdnialumno" method="POST" action="">
                        ...
                        <div class="col-lg-2"><label>Buscar Docente por Dni:</label></div>
                        <div class="col-lg-6">
                                ...
                                while ($row = $rs->fetch_assoc()) {
                                    ...
                                    <table class="table table-striped table-bordered bg-info">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>'.$row["Id"].'</td>
                                                <td>'.$row["NroLegajoJunta"].'</td>
                                                <td>'.$row["nombres"].'</td>
                                                <td>'.$row["DNI"].'</td>
                                                <td><a class="btn btn-primary btn-sm" href="buscarUnDocente.php?Cy=0&Cx='.$row["Id"].'">Ver docente</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>';
