...
?>
	<div class="row" align="center">
      <div class="col-lg-12"><div class="tile"><h2 class="tile-title" ><font color="#85C1E9"><center><b>Contenidos y Aprendizajes de <?php echo $NEC?></b></font></h2>  </div></div>
    </div> <!-- /.row titulo --><br>
    <div class="row">
      <div class="col-lg-12">
...
?><div class="row" align="center">
          <div class="col-lg-12">	
			<div class="alert alert-dismissible alert-danger">
                  <strong><center>El espacio curricular no tiene registrado ningún contenido</center></strong>
            </div>
         </div>
		 </div><br><br>
		 <div class="row" align="center">
