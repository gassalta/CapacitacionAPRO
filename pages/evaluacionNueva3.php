       ...
       <div class="row">
         <div class="col-lg-10">
           <div class="panel panel-primary">
             <div class="panel-heading"><center> Ingrese <b>todos</b> lo datos de la evaluaci&oacuten </center> </div><br>
...
<?php
 ...
 ?>
          ...
          <div class="col-lg-8"><input class="form-control" name="EspaCurri" value="<?php echo $EC; ?>" readonly></div> </div>
       </div><!--fin row espacio curricular--><br><br><br>
	   <div class="row"align="center">
         <div class="form-group">
		 <div class="col-lg-1"></div>
