    ...
    <div class="row">
     <div class="col-lg-10">
      <div class="panel panel-primary">
        <div class="panel-heading"><center>Espacio Curricular N°<?php echo $idEC;?></center></div><br>
...
?>
		...
		<div class="row">
			...
			<div class="panel panel-info">
             <div class="panel-heading"><center><b>¿ En qué curso se dicta	?</b></center></div>
             <div class="panel-body">
...
?>
                   ...
                   <div class="radio"><label><input type="radio" name="curso" id="<?php echo $Listado[$i]['ID']; ?>" value="<?php echo $Listado[$i]['ID']; ?>" <?php echo ($EsDeCurso == 1) ? 'checked' : ''; ?>>Año:  <?php echo $Listado[$i]['ANIO']." - Division: ".$Listado[$i]['DIVISION']; ?></label></div>
<?php
                 }
?>	  
					<div class="radio"><label><input type="radio" name="curso" id="curso" value="0" <?php echo ($TieneCurso == 0) ? 'checked' : '';?>><font color="red">No registrado en ningún curso</font></label></div>
					</div>
		    </div><!-- /.row checkbox -->
			</div>
