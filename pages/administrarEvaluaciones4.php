    ...
    <div class="row">
                        ...
                        //Cargo a la tabla el listado de las evaluaciones
                            for ($i=0; $i < $CantidadEvaluaciones; $i++) { ?>
                                <tr class="table-info">
									...
									<?php                                    
									echo'<td><a href="buscarUnaEvaluacion.php?Tx=M&Cx='.$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC.'"><box-icon name="search-alt"  size="md" color="black" animation="tada-hover"></box-icon></a></td>';
                                    if ($_SESSION['Categoria'] == 'Docente' || $EC != '') {
									echo'<td><a href="modificarEvaluacion.php?Tx=M&Cx='.$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC.'"><box-icon name="edit-alt" type="solid" size="md" color="black" animation="tada-hover"></box-icon></a></td>';
									echo'<td><a href="eliminarEvaluacion.php?Tx=M&Cx='.$ListadoEvaluaciones[$i]['ID'].'&Ec='.$EC.'"><box-icon name="trash" " size="md" color="black" animation="tada-hover"></box-icon></a></td>';
                                }?>
                                </tr> 
                         <?php   }
	  ...
	  <div class="row">
				...
				<div class="col-lg-2"></div>
				 <div class="col-lg-4">
        <?php if ($_SESSION['Categoria'] == 'Docente' || $EC != '') { ?>
				<button class="btn btn-primary" type="submit" name="ContenidoNuevo" formaction="<?php echo 'evaluacionNueva.php?Cx='.$EC; ?>"><box-icon name="plus-circle" type="solid" size="sm" color="white" animation="tada-hover"></box-icon> Nueva
                </button></div>
        <?php } ?>
